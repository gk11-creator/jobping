...
- 파트타임, 알바, 아르바이트, 단기, 시급, 홀서빙, 세척, 주방, 배달, 청소 관련 공고
- 공고 제목에 "파트", "홀", "주방", "세척", "배달", "시급", "알바" 포함된 경우
- 구직자 희망 고용형태({user_profile.get('employment_type')})와 완전히 다른 고용형태
- 구직자 희망 직군({user_profile.get('category')})과 전혀 무관한 직군
- 학원, 과외, 교육생 모집, 수강생 모집 공고
위 조건에 해당하면 해당 공고는 반드시 제외하고 다른 공고를 선택할 것.
